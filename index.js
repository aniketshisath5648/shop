...
cartButton.addEventListener("click", function() {
 ...
 var nwDi = document.querySelector('.produ');
 var mainClass = document.getElementById('main-one');

 nwDi.appendChild(mainClass);
 document.getElementById("proj").appendChild(nwDi);
